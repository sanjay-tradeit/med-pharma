                        ...
                        <div class="card card-inverse card-info d-flex" style="flex: 1 1 100%;">
                            <div class="card-body" style="position: relative;">
                                <div class="d-flex align-items-center mb-2">
                                    <div class="m-r-20 ">
                                        <h1 class="text-white card-icon"><i class="fa fa-user float-right"></i></h1>
                                    </div>
                                    <div class="mr-auto">
                                        <h4 class="card-title mb-0">Wholesale  Customer</h4>
                                    </div>
                                    <h2 class="font-light text-white mb-0">
                                        <?php 
                                ...
                                <div class="d-flex align-items-center mb-2">
                                    ...
                                    <div class="mr-auto">
                                        <h4 class="card-title mb-0">Regular Customer</h4>
                                    </div>
                                    <h2 class="font-light text-white mb-0">
                                        <?php 
                                ...
                                <div class="d-flex align-items-center mb-1">
                                    ...
                                    <div class="mr-auto">
                                        <h4 class="card-title mb-0">Walk In Customer</h4>
                                    </div>
                                    <h2 class="font-light text-white mb-0">
                                        <?php 
                                            $this->db->where('c_type', 'Walkin');
                                            $query = $this->db->get('customer');
                                            echo $query->num_rows(); ;
                                        ?>
                                    </h2>
                        ...
                        <div class="card card-inverse card-success">
                            <div class="card-body">
                                <div class="d-flex  align-items-center">
                                    <div class="m-r-20 ">
                                        <h1 class="text-white card-icon"><i class="fa fa-medkit float-right"></i></h1></div>
                                        <div class="mr-auto">
                                        <h4 class="card-title mb-0">TOTAL MEDICINE</h4>
                                        </div>
                                        <h2 class="font-light text-white mb-0"><?php 
                    ...
                    <div class="col-lg-3 col-md-12 batch-d">
                        <div class="card card-inverse card-danger">
                            <div class="card-body">
                                <div class="d-flex  align-items-center">
                                    <div class="m-r-20 ">
                                        <h1 class="text-white card-icon"><i class="fa fa-handshake-o float-right"></i></h1></div>
                                        <div class="mr-auto">
                                          <h4 class="card-title mb-0">TOTAL SUPPLIER</h4>
                                        </div>
                                        <h2 class="font-light text-white mb-0"><?php 
                    ...
                    <div class="col-lg-3 col-md-12 batch-d">
                        <div class="card card-inverse card-primary">
                            <div class="card-body">
                                <div class="d-flex  align-items-center">
                                    <div class="m-r-20">
                                        <h1 class="text-white card-icon"><i class="fa fa-pencil-square-o float-right"></i></h1></div>
                                    <div class="mr-auto">
                                        <h4 class="card-title mb-0">SALES TODAY</h4>
                                        </div>
                                        <h2 class="font-light text-white mb-0"><?php 
                                                $this->db->where('create_date', date('d/m/Y'));
                                    ...
                                    <a href="<?php echo base_url() ?>Sales/Sales_report">
                                     ...
                                     <!-- <?php print_r($value); ?> -->
                                        ...
                                        <div class="mail-contnet">
                                            ...
                                            <h6><?php echo $value->product_name?> </h6> <span class="mail-desc"><?php echo $value->generic_name?></span> <span class="time"><?php echo date("d-m-Y", strtotime($value->expire_date))?></span> </div>
                                    </a>
                                    <?php endforeach;?>
                                </div>
                            </div>
