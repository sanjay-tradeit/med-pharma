...
<style>
    ...
    color: red;
        ...
        <div class="row m-b-10"> 
            ...
            <div class="col-12">
                <button type="button" class="btn btn-info" style="margin-top: 10px; margin-left: 10px;"><i class="fa fa-plus"></i><a href="<?php echo base_url();?>Customer/download" class="text-white"><i class="" aria-hidden="true"></i> Download Sample</a></button>
    
            </div>
        </div>
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Import Supplier</h3>
                </div>
                    ...
                    <div class="col-12">
                        <div class="card card-outline-info">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Import Supplier</h4>
...
$.ajax({
    url: "<?php echo base_url();?>Customer/read_supplier",
    type: 'POST',
    data: formData,
    dataType: "json",
    async: false,
