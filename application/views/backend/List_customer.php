...
<!--                                                     <a href="#" title="Delete" class="btn btn-sm btn-info waves-effect waves-light"><i class="fa fa-trash-o"></i></a> -->
                                                    <a href="" title="Print" data-toggle="modal" class="btn btn-sm btn-info waves-effect waves-light barcodegenerator"  data-id="<?php echo $value->c_id; ?>"><i class="fa fa-barcode"></i></a>
                                                </td>
                                            </tr>
                                            <?php endforeach;?>
                                        </tbody>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="">
                                        <input type="text" class="form-control" name="cphone" placeholder="Phone number">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group w-p-100">
                                    ...
                                    <div class="w-p-80 pull-left">
                                        ...
                                        <label for="img_url"><a>Upload</a></label>  <span id="image_name"></span>
                                    </div>
        ...
        $(document).ready(function () {
            ...
            $(".customerid").click(function (e) {
                ...
                $.ajax({
                    ...
                    document.querySelector("#image_name").textContent = response.mvalue.c_img;
