                                    ...
                                    <table id="myTable" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <thead>
                                            ...
                                            <th class="w-p-20">Medicine Id</th>
                                                ...
                                                <th class="w-p-15">Batch</th>
                                                <th class="w-p-15">In Stock</th>
                                                <th class="w-p-15">Purchase Rate</th>
                                        ...
                                        <tbody>
                                           ...
                                           <?php foreach($allSupplier as $value): ?>
                                               ...
                                               <td><?php echo $value->product_id;?></td>
                                                ...
                                                $b = strtotime($a);
                                                    if($today >= $b){
                                                        echo "<span style='color:red'>".date("d-m-Y", strtotime($value->expire_date))."</span>";
                                                    } else {
