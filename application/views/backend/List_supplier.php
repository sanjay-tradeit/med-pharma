            ...
            <div class="container-fluid p-t-10">
                <div class="row m-b-10"> 
                    <div class="col-12">
                        ...
                        <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a href="<?php echo base_url();?>Customer/import_supplier" class="text-white"><i class="" aria-hidden="true"></i>  Import Supplier's </a></button>
                    </div>
                </div>
                        ...
                        <div class="card card-outline-info">
                            ...
                            <div class="card-body">
                                <div class="table-responsive ">
                                    <table id="example90" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                <th class="w-p-10">Supplier ID </th>
                                                <th class="w-p-10">Supplier Name</th>
                                                <th class="w-p-10">GST No.</th>
                                           ...
                                           <?php foreach($supplierList as $value): ?>
                                            <tr>
                                                ...
                                                if (in_array(31, $permissions)) { ?>
                                                    ...
                                                    <?php } ?>
                                                    <a href="<?php echo base_url();?>supplier/Medicine_View?S=<?php echo $value->s_id;?>" title="View Supplier Medicines" class="btn btn-sm btn-info waves-effect waves-light"><i class="fa fa-medkit"></i></a>
    ...
    <div class="modal-content">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <input type="text" onkeyup="checksupname()" id="sname" name="sname" class="form-control" placeholder="Supplier name" value="" minlength="1">
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <input onkeyup="checkgst()" type="text" name="gst" class="form-control" id="gst" placeholder="GST" value="" minlength="1">
                    </div>
                </div>
            </div>
            <div class="col-md-6">
      ...
      <div class="modal-footer">
       <input id="sid" type="hidden" name="sid" value="">
        ...
        <button type="submit" id="add_btn" class="btn btn-info">Submit</button>
      </div>
      </form>
    </div>
  </div>
            ...
            $(document).ready(function () {
                $(".supplierid").click(function (e) {
                    ...
                    $.ajax({
                        ...
                        $('#supplierfORM').find('[name="gst"]').val(response.mvalue.s_gst).end();
...
function checkgst(){
            ...
            gdata ={gst: gst,sid: sid};
            $.ajax({
                type: "POST",
                dataType: 'html',
                url: "checksuppliergstedit",
                data: gdata,
               
                
          success: function(response) {
              if(response == 'error') { 
                $("#gst").css("border-color","#ff9797");
              
              } else if(response == 'success') {
                $("#gst").css("border-color","#00000026");
        ...
        function checksupname(){
            var supname = $("#sname").val();
            
            gdata ={sname: supname};
            $.ajax({
                type: "POST",
                dataType: 'html',
                url: "checksuppliername",
                data: gdata,
               
                
          success: function(response) {
              if(response == 'error') { 
                $("#sname").css("border-color","#ff9797");
                $('#add_btn').attr('disabled','disabled');
              
              } else if(response == 'success') {
                $("#sname").css("border-color","#67757c");
