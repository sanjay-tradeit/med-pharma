                        ...
                        <div class="card card-outline-info">
                            ...
                            <div class="card-body">
                                <div class="table-responsive ">
                                    <table id="example00" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                <th>Medicine Name</th>
                                                <th>Generic Name</th>
                                        ...
                                        <tbody>
                                           ...
                                           $store_id = $this->session->userdata('store_id');
                                             $CI     = & get_instance();
                                             $get_received = $CI->get_received($value->product_id, $value->supplier_id, $value->Batch_Number);
