                                        ...
                                        <tbody>
                                           <?php foreach($invoice as $value):  ?>
                                            <tr>
                                                ...
                                                <td><?php echo round($value->total_amount, 4); ?></td>
                                                <td><?php echo round($value->paid_amount, 4); ?></td>
                                                <td><?php echo round($value->due_amount, 4); ?></td>
...
<div id="invoicemodal" class="modal fade bs-example-modal-md" role="dialog" role="dialog" aria-labelledby="mySmallModalLabel" tabindex="-1" >
...
$( ".close" ).click(function() {
  ...
  <script type="text/javascript">
    $(document).ready(function () {
        $(".invoicegenerator").click(function (e) {
