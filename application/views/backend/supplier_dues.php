                        ...
                        <div class="card card-outline-info">
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive ">
                                    ...
                                    <table id="example234009" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                           ...
                                           <?php foreach($duesvalue as $value): ?> 
                                            <tr>
                                                ...
                                                <td class="jsgrid-align-center ">
                                                  ...
                                                  <?php  } else{?>
                                                    <a href="" title="Pay" class="btn btn-sm btn-info waves-effect waves-light duesid" data-id="<?php echo $value->pur_id; ?>"><i class="fa fa-paypal"></i></a> 
                                                  <?php    }?>
        ...
        $(document).ready(function () {
            ...
            $(".duesid").click(function (e) {
                ...
                $.ajax({
                    ...
                    $('#smodel').find('[name="sid"]').val(response.mvalue[0].supplier_id).end();
                    $('#smodel').find('[name="pid"]').val(response.mvalue[0].pur_id).end();
                    $('#smodel').find('[name="sname"]').val(response.mvalue[0].s_name).end();
                    $('#smodel').find('[name="due"]').val(response.mvalue[0].due_amount).end();
                });
            });
        });   
