                      ...
                      <div class="row">
                        ...
                        <div class="col-md-3">
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-md-7">
                              <input class="form-control totalTax" id="totalTax" name="totalTax" type="tax" value="" style="" tabindex="-1" readonly>
                            </div>
                          </div>
                          <div class="row form-group">
                            <div class="col-md-5">
                            ...
                            <div class="col-md-7">
                              <input class="form-control gdiscount" name="gdiscount" type="text" style="" tabindex="-1">
                            </div>
                          </div>
                          <div class="row form-group">
                            <div class="col-md-5">
...
<script>
  ...
  //   window.setTimeout(function() {
  //                 window.location = "https://browncrystal.com/mad-pharma/Invoice/manage_Invoice";
  //             }, 2000);
  // });
</script>
<script type="text/javascript">
...
<script>
  $(document).on("click", '#add_pos', function(e) {
    ...
    var stock = $(this).closest('.row').find('[name="stock"]').val();
