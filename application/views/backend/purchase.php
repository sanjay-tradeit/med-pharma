                    ...
                    <div class="col-12">
                        <div class="card card-outline-info">
                            <div class="card-header">                                
                                <h4 class="m-b-0 text-white">Manage Purchase <span class="pull-right"><?php date_default_timezone_set("Asia/Kolkata"); echo date("l jS \of F Y h:i:s A") ?></span></h4>
                            </div>                            
                            <div class="card-body">
                                <div class="table-responsive ">
                                    <table id="example2340091" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                <!--<th>ID </th>-->
                                                <th>Supplier Name</th>
                                        ...
                                        <tbody>
                                           ...
                                           <?php foreach($Purchase as $value):
                                            // $CI     = & get_instance();
                                            // $result = $CI->getStorename($value->store_id);
                                           // print_r($result->store_name);
                                            ...
                                            <tr><!--
                                                ...
                                                <td><?php echo date("d-m-Y", strtotime($value->pur_date)); ?></td>                                                
                                                ...
                                                <td class="jsgrid-align-center ">
                                                   <a href="javascript:void(0);" id="invoId" title="Print Invoice" class="btn btn-sm btn-info waves-effect waves-light invoId" data-id="<?php echo $value->p_id; ?>"><i class="fa fa-print"></i></a>
                                                   <a target="_blank"href="Purchase_History?H=<?php echo base64_encode($value->p_id) ?>" id="invoId" title="View" class="btn btn-sm btn-info waves-effect waves-light"><i class="fa fa-history"></i></a>
                                                   <?php $permissions = explode(',', $permissions1);
                                                if (in_array(35, $permissions)) { ?> 
                                                   
                                                   <a target="_blank"href="Purchase_Invoice_edit?H=<?php echo base64_encode($value->p_id) ?>" id="invoId" title="Edit" class="btn btn-sm btn-info waves-effect waves-light"><i class="fa fa-pencil-square-o"></i></a> 
                                                   <?php } ?>
                                                </td>
                                            </tr>
                                            <?php endforeach; ?>
...
$(document).ready(function () {
    $("#example2340091").on("click", ".invoId", function(e){
