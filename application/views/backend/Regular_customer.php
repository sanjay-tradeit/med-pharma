                                        ...
                                        <tbody>
                                           <?php foreach($RegulatList as $value): 
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo round($value->target_amount, 2); ?></td>
                                                <!--<td>26000</td>-->
                                                <td><?php echo round($value->regular_discount, 2); ?>%</td>
                                                <td>
                                                ...
                                                if (in_array(5, $permissions)) { ?>
                                                    ...
                                                    <?php } ?>
                                                    <a href="" title="Print" data-toggle="modal" data-target=".bs-example-modal-md" class="btn btn-sm btn-info waves-effect waves-light barcodegenerator"  data-id="<?php echo $value->c_id; ?>"><i class="fa fa-barcode"></i><a>                                                    
                                                </td>
                                            </tr>
                                            <?php endforeach; ?>
                                        </tbody>
          ...
          <div class="modal-dialog modal-lg"   style="max-width:60%!important"  role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Update Regular Customer</h5>
                                        ...
                                        <label for="radio_2">Wholesale Customer</label>
                                            ...
                                            <div class="col-md-6" id="storeneme">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="">
                                                        <input type="text" class="form-control" name="pcname" placeholder="Phrmacy Name" minlength="1">
                                                    </div>
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group ">
                                    ...
                                    <div class="width:100% type-input-box">
                                        <label for="img_url"class="w-100">  <input type="file" name="files[]" id="img_url" class=" d-none" aria-describedby="fileHelp">
                                      <a >Upload</a> <span id="image_name"></span>
                                      </div></label> 
                                        <div class="file_prev">
                                        <img src="" name="product_image" class="img-responsive postimg" id="image" style="">
                                   
                                    </div>

                                    <!-- <div class="width:100%">
                                        <input type="file" name="files[]" id="img_url" style="width:90%" class="form-control" aria-describedby="fileHelp">
...
<script>
    $('#update_sbt_btn').on("click", function(){
   window.setTimeout(function() {
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $("#example2").on("click", ".customerid", function(e){
           ...
           <script type="text/javascript">
                $(document).ready(function () {
                    $("#example2").on("click", ".barcodegenerator", function(e){
