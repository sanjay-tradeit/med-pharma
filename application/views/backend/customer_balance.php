              ...
              <form action="Update_Balance" method="post"  id="cmodel"  class="form-horizontal"  enctype="multipart/form-data" accept-charset="utf-8">
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-6" id="tamount" style="display: none">
                                <div class="form-group">
                        ...
                        <div id="custDues"><div class="row"><div class="col-md-3">Invoice Date</div><div class="col-md-3">Invoice No.</div><div class="col-md-3">Due Amount</div><div class="col-md-3">Pay Amount</div></div></div>
                ...
                $(document).ready(function () {
                    $(".cbalanceid").click(function (e) {
                        ...
                        $.ajax({
                            ...
                            // invoice details
                            $('#custDues').append(response.duevalue);
