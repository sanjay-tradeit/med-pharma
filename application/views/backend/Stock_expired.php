                        ...
                        <div class="card card-outline-info">
                            ...
                            <div class="card-body">
                                <div class="table-responsive ">
                                    <table id="example2881" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                <th>Medicine Name</th>
                                                <th>Generic Name</th>
...
$('#example2881').dataTable( {
        ...
        // "ordering": false,
            ...
            buttons: [
                            {
                                extend: 'copy',
                                title: 'Stock Expired Medicine List (Main Store)'
                            },
                            {
                                extend: 'excel',
                                title: 'Stock Expired Medicine List (Main Store)'
