                    ...
                    <div class="col-12">
                        <div class="card card-outline-info">                     
                            <div class="card-header">                                
                                <h4 class="m-b-0 text-white">Edit Purchase <span class="pull-right date-display"><?php date_default_timezone_set("Asia/Kolkata"); echo date("l jS \of F Y h:i:s A") ?></span></h4>
                            </div>
                            <div class="card-body">
                                        ...
                                        <div class="col-md-3">
                                                ...
                                                <select class="form-control select2 supplier" name="supplier_name" id="supplier_name" requird style="width:100%" autocomplete="off" readonly>
                                                          ...
                                                          <?php foreach($supplierList as $value):?>
                                                            <option <?php if($value->s_id == $purchasehistory[0]->supp_id){echo "selected";}else{} ?> value="<?php echo $value->s_id; ?>"><?php echo $value->s_name; ?></option>
                                                            <?php endforeach; ?> 
                                                </select>
                                                        ...
                                                        <input type="hidden" class="form-control pur_id" name="pur_id" value="<?php echo base64_decode($_GET['H']);?>" id="pur_id" autocomplete="off">                                             
                                                </div>
                                            </div> 
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group" style="margin-bottom: 15px">
                                                    ...
                                                    <input type="text" id="datepicker" class="form-control datepicker" placeholder="" name="entrydate" value="<?php echo $purchasehistory[0]->entry_date ?>" readonly required autocomplete="off">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group" style="margin-bottom: 15px">
                                                    <label class="control-label mb-2">Note</label>
                                                    <textarea type="text" name="details" class="form-control"  readonly placeholder="Details" required rows="1" cols="8"><?php echo $purchasehistory[0]->pur_details ?></textarea>
                                                </div>
                                            </div> 
                                        ...
                                        <tfood> 
                                              <?php
                                                  ...
                                                  foreach ($purchasehistory as $purchase) {
                                                      ...
                                                      $grandTotal = round($totalAmount + $totalTax, 2);
                                                      $totalAdjustment = $purchase->adjustment;
                                                      $totalPaid = round($purchase->paid_amount, 2);
                                                      
                                                  }

                                                  
                                                  $totalDue = $grandTotal + $totalAdjustment - $totalPaid;

                                              ?>

                                              <tr>
                                                  <td class="text-right font-weight-bold" colspan=11>Total:</td>
                                                  <td colspan="2"><input type="text" class="form-control sumAmount" name="sumAmount" placeholder="0.00" readonly="" value="<?php echo $totalAmount ?>"></td>
                                              </tr>
                                              <tr>
                                                  <td class="text-right font-weight-bold" colspan=11>Tax:</td>
                                                  <td colspan="2"><input type="text" class="form-control sumTax" name="sumTax" placeholder="0.00" readonly="" value="<?php echo $totalTax ?>"></td>
                                              </tr>
                                              <tr>
                                                  <td class="text-right font-weight-bold" colspan=11>Discount:</td>
                                                  <td colspan="2"><input type="text" class="form-control Discount" name="Discount" placeholder="0.00" readonly="" value="<?php echo $totalDiscount ?>"></td>
                                              </tr>
                                              <tr>
                                                  <td class="text-right font-weight-bold" colspan=11>Grand Total:</td>
                                                  <td colspan="2"><input type="text" class="form-control gtotal" name="grandamount" placeholder="0.00" readonly="" value="<?php echo $grandTotal ?>"></td>
                                              </tr>
                                              <tr>
                                                  <td class="text-right font-weight-bold" colspan=11>Adjustment(+/-):</td>
                                                  <td colspan="2"><input type="text" class="form-control adjustment" name="billadjustment" placeholder="0.00"  value="<?php echo $totalAdjustment ?>"></td>
                                              </tr>
                                              <tr>
                                                  <td class="text-right font-weight-bold" colspan=11>Total Paid:</td>
                                                  <td colspan="2"><input type="text" class="form-control paid" name="paid" placeholder="0.00"  value="<?php echo $totalPaid ?>"></td>
                                              </tr>
                                              <tr>
                                                  <td class="text-right font-weight-bold" colspan=11>Total Due:</td>
                                                  <td colspan="2"><input type="text" class="form-control due" name="due" placeholder="0.00" readonly="" value="<?php echo $totalDue ?>"></td>
                                              </tr>
       ...
       $(document).ready(function(){
          $.ajax({
            ...
            $(document).ready(function() {
                ...
                var supplier_id = $('#invoice').val(); 
                $('#invoice').val(supplier_id); 
                
                $.ajax({
                    url: 'medicinebysupplierId6',
                    method: 'GET',
                    data: { id: supplier_id },
                }).done(function(response) {
                    $("#addPurchaseItem").append(response); 
