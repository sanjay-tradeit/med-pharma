            ...
            <div class="col-12">
                <div class="card card-outline-info">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-6">
                                <h4 class="m-b-0 ">Slow Moving Items Report</h4>
                            </div>
        ...
        sheet.childNodes[0].childNodes[1].innerHTML = r1+ r2+ sheet.childNodes[0].childNodes[1].innerHTML;
                            ...
                            },
                            {
                                ...
                                customize: function(pdfDocument) {
                                    pdfDocument.styles.quote = {
                                                color: 'black',
                                                fontSize: '10',
                                               // background: 'blue',
                                                alignment: 'Right'
                                                }
                                    pdfDocument.styles.title = {
                                                color: 'black',
                                                fontSize: '15',
                                               // background: 'blue',
                                                alignment: 'Right'
                                    ...
                                    var firstHeaderRow = [];
                                    $('#myTable55').find("thead>tr:first-child>th").each(
