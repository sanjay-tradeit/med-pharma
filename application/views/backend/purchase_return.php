    ...
    $(document).ready(function () {
      ...
      <!--Purchase calculation-->      
          ...
          $(document).on('keyup','.rqty, .total',function() { 
            ...
            var retDataID = $('#return').data("return");

            var unitMrp = $('#'+ retDataID).val();
          ...
          <script>
$(document).on("input", "#return", function(e){
  var receivedQty = parseFloat($('#received').val());
