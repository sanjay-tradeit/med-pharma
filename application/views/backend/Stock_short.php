                        ...
                        <div class="card card-outline-info">
                            ...
                            <div class="card-body">
                                <div class="table-responsive ">
                                    <table id="example66" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                <th>Medicine Name</th>
                                                <th>Generic Name</th>
        ...
        // "aaSorting": [[3,'desc']],
         //"ordering": false,
            ...
            buttons: [
                            {
                                extend: 'copy',
                                title: 'Short Stock Medicine List (Main Store)'
                            },
                            {
                                extend: 'excel',
                                title: 'Short Stock Medicine List (Main Store)'
