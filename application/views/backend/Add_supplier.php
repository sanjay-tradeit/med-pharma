                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card card-outline-info">
                            <div class="card-header">                                
                                <h4 class="m-b-0 text-white">New Supplier <span class="pull-right"><?php date_default_timezone_set("Asia/Kolkata"); echo date("l jS \of F Y h:i:s A") ?></span></h4>
                            </div>
                            <div class="card-body">
                                ...
                                <form action="" method="post" id="Smodel" enctype="multipart/form-data" accept-charset="utf-8" class="form-horizontal">
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        <input onkeyup="checksupname()" type="text" id="sname" class="form-control sname" name="sname" placeholder="Supplier Name..." required>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="control-label text-right col-md-3">GST<span class="text-danger">*</span></label>
                                                    <div class="col-md-9">
                                                    <input onkeyup="checkgst()" id="gst" required type="text" name="gst" class="form-control gst" placeholder="GST no...">
                                                    </div>
                                                </div>
                                            </div> 
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        <input type="number" class="form-control sphone" placeholder="Phone Number..." name="sphone" required>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <textarea placeholder="Note..." class="form-control snote" name="snote" rows="1"></textarea>
                                                    </div>
                                                </div>
                                            </div>
