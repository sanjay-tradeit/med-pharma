...
?>
    ...
    border-color: #f7f5f5;
            ...
            <div class="container-fluid p-t-10">
                    ...
                    <div class="col-12">
                        <div class="card card-outline-info">                     
                            <div class="card-header">                                
                                <h4 class="m-b-0 text-white">Edit Purchase Draft <span class="pull-right date-display"><?php date_default_timezone_set("Asia/Kolkata"); echo date("l jS \of F Y h:i:s A") ?></span></h4>
                            </div>
                            <div class="card-body">
                                <div class="pur_inputs add-purchase">
                                    <form action="<?php echo base_url(); ?>purchase/update_draft" method="post" class="form-horizontal" enctype="multipart/form-data" accept-charset="utf-8" id="purchaseForm"> 
                          
                                        <div class="row">
                                        <div class="col-md-3">
                                                <div class="form-group" style="margin-bottom: 15px">
                                                <label class="control-label mb-2">Supplier Name</label>
                                                <select class="form-control select2 supplier" name="supplier_name" id="supplier_name" requird style="width:100%" autocomplete="off" readonly>
                                                          <option value="">Select Supplier</option>
                                                          <?php foreach($supplierList as $value):?>
                                                            <option <?php if($value->s_id == $purchasehistory[0]->supplier_id){echo "selected";}else{} ?> value="<?php echo $value->s_id; ?>"><?php echo $value->s_name; ?></option>
                                                          <?php endforeach; ?> 
                                                </select>
                                                        ...
                                                        <input type="hidden" class="form-control supplier" name="supplier1" value="<?php echo $purchasehistory[0]->supplier_id; ?>"  id="supplier1" autocomplete="off">
                                                        <input type="hidden" class="form-control supplier" name="supplier2" value="<?php echo $purchasehistory[0]->id; ?>"  id="supplier2" autocomplete="off">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group" style="margin-bottom: 15px">
                                                    ...
                                                    <input type="text" id="invoice" name="invoice" class="form-control" placeholder="Invoice No" value="<?php echo $purchasehistory[0]->invoice_no ?>" readonly autocomplete="off" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group" style="margin-bottom: 15px">
                                                    ...
                                                    <input type="text" id="datepicker" class="form-control datepicker" placeholder="" name="entrydate" value="<?php echo $purchasehistory[0]->invoice_date ?>" readonly required autocomplete="off">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group" style="margin-bottom: 15px">
                                                    <label class="control-label mb-2">Note</label>
                                                    <textarea type="text" name="details" class="form-control"  readonly placeholder="Details"  rows="1" cols="8"><?php echo $purchasehistory[0]->note ?></textarea>
                                                </div>
                                            </div> 
                                        ...
                                        <div class="col-md-3">
                                                <div class="form-group" style="margin-bottom: 15px">
                                                    ...
                                                    <input type="number"  name="delivery_time" class="form-control delivery_time" value="<?php echo $purchasehistory[0]->delivery_time ?>" readonly placeholder="Delivery time"  autocomplete="off" >
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group" style="margin-bottom: 15px">
                                                    <label class="control-label mb-2">Payment Time(Days)</label>
                                                    <input type="number" name="payment_time" class="form-control payment_time" placeholder="Payment time" value="<?php echo $purchasehistory[0]->payment_time ?>" readonly  autocomplete="off" >
                                    ...
                                    <table class="table table-bordered m-t-5 pos_table  purchase">
                                        ...
                                        <!-- <?php $due = ($purchasehistory[0]->gtotal_amount) - ($purchasehistory[0]->paid_amount); ?> -->
                                        ...
                                        <?php if(!empty($medicine)){
                                          foreach ($medicine as $value) {
                                            ...
                                            $igst = $CI->GetHsnDetailsById1($value->hsn);
                                            $totalpri = $value->qnty * $value->purchase_rate;
                                            
                                            if(!empty($value->discount))
                                            {
                                             $totdis = ($totalpri * $value->discount)/100; 
                                             $totalpri = $totalpri - $totdis;
                                             $tax1 = ($totalpri * $igst->igst)/100;
                                            }
                                            $tax1 = ($totalpri * $igst->igst)/100;
                ...
                <tr>    
                            <td>
                            <input type='hidden' class='form-control medicine' id='medicine' name='medicine[]' placeholder='' readonly value='<?php echo $value->medicine_id;?>'>
                            <input type='text' class='form-control'  name='mname[]' readonly value='<?php echo $value->product_name;?>'>
                            <input type='hidden' class='form-control'  name='ids[]' readonly value='<?php echo $value->id;?>'>
                            </td>
                            <td><input type='text' class='form-control' name='gname[]' placeholder='' readonly value='<?php echo $value->generic_name;?>'></td>
                            <td><input id='form' type='text' class='form-control' name='model[]' placeholder='' readonly value='<?php echo $title;?>'></td>
                            <td style='width: 110px;'>
                                <select id='units$string' class='form-control' name='units[]'>";
                                <?php
                                if(!empty($value->subform)){
                                  $medsubFormArray= explode(',',$value->subform);
                                  }
                                  else{
                                      
                                  }
                                  // print_r($medsubFormArray);
                                  foreach ($medsubFormArray as $unitid) {
                                    $CI = &get_instance();
                                    $results = $CI->gettitlebyform($unitid);
                                
                                    foreach ($results as $result) {
                                    
                                       $selected = ($value->unit == $result->id) ? "selected" : "";
                                        echo "<option value='".$result->id."' $selected >".$result->unit."</option>";
                                    }
                                }
                                
                                // $disc = ($value->totaldiscount*100)/$value->total;
                            ...
                            <td><input type='text' class='form-control batch_no' name='batch_no[]'  value='<?php echo $value->batch;?>'></td>
                            <td><input type='text' class='form-control datepicker valid' name='expiredate[]' value='<?php echo $value->exp_date;?>' id='datepicker' required></td>
                                                      
                            <td><input type='text' class='form-control qty' name='qty[]' placeholder='0.00' value='<?php echo $value->qnty;?>' required></td>    
                            <td><input type='text' class='form-control freeqty' name='freeqty[]' placeholder='0.00' value='<?php echo $value->free_qnty;?>'></td>                                                      
                            <td><input type='text' class='form-control tradeprice' name='tradeprice[]' placeholder='0.00' value='<?php echo $value->purchase_rate;?>'></td>
                            <td><input type='text' class='form-control mrp' name='mrp[]' placeholder='0.00' value='<?php echo $value->mrp;?>'></td>
                            
                            <td><input type='text' class='form-control wholesaler' name='wholesaler[]' placeholder='0.00' value ='<?php echo $value->discount;?>'><input type='hidden' class='form-control discount' name='discount[]' placeholder='0.00' value ='0'></td>
                            <td><input readonly type='text' class='form-control tax' name='tax[]' placeholder='0.00' value ='<?php echo $tax1;?>'>
                            <input type='hidden' class='form-control hsn' name='hsn[]'  value='<?php echo $igst->igst;?>'></td>
                            <td><input readonly type='text' class='form-control total' name='total[]' placeholder='0.00' value='<?php echo $totalpri;?>'>
                            ...
                            <td id='btn'><i class='fa fa-times-circle-o' aria-hidden='true'></i></td>
                             ...
                             <?php } } ?>   
                                        ...
                                        <tr>
                                                ...
                                                <td colspan="2"><input type="text" class="form-control sumAmount" name="sumAmount" placeholder="0.00" readonly="" value="<?php if(!empty($value->total)){echo $value->total;}else{}?>"></td>
                                            </tr>
                                            <tr>
                                                <td class="text-right font-weight-bold" colspan=11>Tax:</td>
                                                <td colspan="2"><input type="text" class="form-control sumTax" name="sumTax" placeholder="0.00" readonly="" value="<?php if(!empty($value->tax)){echo $value->tax;}else{}?>"></td>
                                            </tr>
                                            <tr>
                                                <td class="text-right font-weight-bold" colspan=11>Discount:</td>
                                                <td colspan="2"><input type="text" class="form-control Discount" name="Discount" placeholder="0.00" readonly="" value="<?php if(!empty($value->totaldiscount)){echo $value->totaldiscount;}else{}?>"></td>
                                            </tr>
                                            <tr>
                                                <td class="text-right font-weight-bold" colspan=11>Grand Total:</td>
                                                <td colspan="2"><input type="text" class="form-control gtotal" name="grandamount" placeholder="0.00" readonly="" value="<?php if(!empty($value->grandTotal)){echo $value->grandTotal;}else{}?>"></td>
                                            </tr>
                                            <tr>
                                                <td class="text-right font-weight-bold" colspan=11>Adjustment(+/-):</td>
                                                <td colspan="2"><input type="text" class="form-control adjustment" name="billadjustment" placeholder="0.00"  value="<?php if(!empty($value->adjustment)){echo $value->adjustment;}else{}?>"></td>
                                            </tr>
                                            <tr>
                                                <td class="text-right font-weight-bold" colspan=11>Total Paid:</td>
                                                <td colspan="2"><input type="text" class="form-control paid" name="paid" placeholder="0.00" value="<?php if(!empty($value->paid)){echo $value->paid;}else{}?>"></td>
                                            </tr>
                                            <tr>
                                                <td class="text-right font-weight-bold" colspan=11>Total Due:</td>
                                                <td colspan="2"><input type="text" class="form-control due" name="due" placeholder="0.00" readonly="" value="<?php if(!empty($value->due)){echo $value->due;}else{}?>">
                                    ...
                                    <button class="btn btn-info float-right" type="submit">Save As Draft</button>
                                    </form>
                                </div>
                            </div>
                        </div>
...
<script>
    $(document).on("click", "#btn", function() {
        ...
        $('.qty, .tradeprice, .mrp, .total, .wholesaler, .gtotal, .paid, .due, .adjustment').trigger('keyup');
    });
</script>
          ...
          $.ajax({
            ...
            <script>
              $('#add_btn').on("click", function(e){
                e.preventDefault();
                 var id = $('#supplier').val();
                 $.ajax({
                url: '<?php echo base_url(); ?>/purchase/medicinebysupplierId?id=' + id,
                method: 'GET',
                data: '',
            ...
            <script>
              $('#update_draft').on("click", function(e){
                ...
                url: '<?php echo base_url(); ?>purchase/update_draft?id=' + id,
                method: 'POST',
                dataType: 'html',
                data: data,
                processData: false,
       ...
       <script type="text/javascript">
        ...
        $("#purchasesubmit").click(function (event) {
            ...
            $.ajax({
                type: "POST",
                enctype: 'multipart/form-data',
                url: "<?php echo base_url(); ?>purchase/Purchase_Review",
                dataType: 'html',
                data: data,
                processData: false,
                contentType: false,
       ...
       <script type="text/javascript">
        ...
        $("#FinalPrint").on('click',function (event) {
            ...
            $.ajax({
                type: "POST",
                enctype: 'multipart/form-data',
                url: "<?php echo base_url(); ?>purchase/Save_Purchase_Invoice",
                dataType: 'html',
                data: data,
                processData: false,
                contentType: false,
       ...
       <script type="text/javascript">
        ...
        $("#FinalSubmitBar").on('click',function (event) {
            ...
            $.ajax({
                type: "POST",
                enctype: 'multipart/form-data',
                url: "<?php echo base_url(); ?>purchase/Save_Purchase_Bar",
                dataType: 'html',
                data: data,
                processData: false,
                contentType: false,
