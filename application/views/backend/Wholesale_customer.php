                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group ">
                                    ...
                                    <div class="width:100% type-input-box">
                                        ...
                                        <label for="product_image"class="w-100"> <input type="file" name="files[]" id="product_image" style="display:none;"/>
...
<script>
   ...
   window.setTimeout(function() {
        ...
        $(document).ready(function () {
            $("#example3").on("click", ".customerid", function(e){
            ...
            <script type="text/javascript">
                $(document).ready(function () {
                    $("#example3").on("click", ".barcodegenerator", function(e){
                    //$(".barcodegenerator").click(function (e) {
                        ...
                        $.ajax({
                            url: '<?php echo base_url();?>Customer/GetBarcodeDomWhole?id=' + iid,
                            method: 'GET',
                            data: '',
                            dataType: 'html',
                        }).done(function (response) {
...
$('#example3').dataTable( {
        ...
        "ordering": false,
            ...
            buttons: [
                            {
                                extend: 'copy',
                                title: 'Wholesale Customers List'
                            },
                            {
                                extend: 'excel',
                                title: 'Wholesale Customers List'
