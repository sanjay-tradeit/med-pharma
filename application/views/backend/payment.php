                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card card-outline-info">
                            <div class="card-header">                                
                                <span><?php date_default_timezone_set("Asia/kolkata"); echo date("l jS \of F Y h:i:s A") ?></span>
                            </div>
                            <div class="card-body">
                                <form action="Save" method="post" id="payment_form" class="form-horizontal" enctype="multipart/form-data" accept-charset="utf-8" id="accountID">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-sm-12">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <label class="control-label text-right col-md-3 col-sm-12">Transaction Name</label>
...
<script>
       $('#submit_btn').click(function(){
        $('#payment_form')..submit();
        $( "#submit_btn" ).remove();
        window.location.href = "<?php echo base_url(); ?>accounts/all_payment";
       });
</script>
<?php 
