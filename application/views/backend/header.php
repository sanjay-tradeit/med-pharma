            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                <div class="navbar-header">
                    <a class="navbar-brand" href="<?php echo base_url();?>">
                        <!-- Logo icon --><b>
                            <img src="<?php echo base_url(); ?>assets/images/Mask.png" alt="homepage" class="dark-logo" />
                                        ...
                                        <div class="message-center">
                                            ...
                                            <a href="#">
                                                <div class="mail-contnet">
                                                    <h5><?php echo $value->product_name?> <?php if(!empty($value->strength)){ echo "(". $value->strength.")";} else {}?></h5> <span class="mail-desc"><?php echo $value->generic_name?></span> <span class="time"><?php echo date("d-m-Y", strtotime($value->expire_date)); echo "(Batch: ".$value->Batch_Number.")"; ?></span> 
                                                    </div>
                                            </a>
                                            <?php endforeach; ?>
                                        </div>
                                    ...
                                    <li>
                                        <div class="message-center">
                                           <?php 
                                            ...
                                            <a href="#">
                                                <div class="mail-contnet">
                                                    <h5><?php echo $value->product_name?> (<?php echo $value->strength?>)</h5> <span class="mail-desc"><?php echo $value->generic_name?></span> <span class="time"><?php echo date("d-m-Y", strtotime($value->expire_date)); echo "(Batch: ".$value->Batch_Number.")"; ?></span> 
                                                    </div>
                                            </a>
                                            <?php endforeach; ?>
                                        </div>
                                        ...
                                        <div class="dw-user-box">
                                           <?php 
                                            $userid =$this->session->userdata('user_login_id');    
                                             $user = $this->user_model->GetEmployeeValueById($userid);
                                             $getrolename = $this->user_model->GetEmployeerolenameByid($user->em_role);
                                            //  $getroleper = $this->user_model->getAllpermissionsbyemid($user->em_role); 
                                            //  $permission = $getroleper[0]->permissions;
                                            ...
                                            <div class="u-text">
                                                <h4 id="uname"><?php echo $user->em_name ?></h4>
                                                <p class="text-muted"><?php echo $user->email ?></p><a href="#" class="btn btn-rounded btn-danger btn-sm"><?php echo $getrolename->title ?></a></div>
                                        </div>
                                    </li>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="password" name="pass" class="form-control" id="recipient-name" required>
                                                        <span class="eye-icon"><i class="fa fa-eye" aria-hidden="true" id="togglePassword"></i></span>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="message-text" class="control-label">Confirm Password</label>
                                                        <input type="password" name="c_pass"  class="form-control" class="password-toggle-icon" id="message-text" required >
